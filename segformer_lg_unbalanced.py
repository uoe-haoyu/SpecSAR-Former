...
from backbone_lg_unbalanced import mit_b2_copy, mit_b1_copy, mit_b0_copy, mit_b4_copy
import torch
...
class SegFormerHead(nn.Module):
    ...
    def forward(self, inputs):
        ...
        n, _, h, w = c4.shape
        # torch.Size([4, 1024, 16, 16]) torch.Size([4, 640, 32, 32]) torch.Size([4, 256, 64, 64]) torch.Size([4, 128, 128, 128])
...
class SegFormer_dual_unbalanced(nn.Module):

    def __init__(self, num_classes=9, phi='b2', pretrained=False):
        super(SegFormer_dual_unbalanced, self).__init__()
